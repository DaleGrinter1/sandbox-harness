...
After training finishes, you can inspect validation loss in the TensorBoard UI.
...
The Gradio UI lets you select a model, enter a prompt, and generate sample text.
